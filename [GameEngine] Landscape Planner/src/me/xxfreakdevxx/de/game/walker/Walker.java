package me.xxfreakdevxx.de.game.walker;
...
import me.xxfreakdevxx.de.game.program.Program;
import me.xxfreakdevxx.de.game.program.SmoothProgram;
...
public class Walker {
	...
	public void tick() {
		if((x >= Landscape.worldWidth) == false) {			
			if(program == null) {
